...
CStopCondition<TGenotype, TFenotype>::CStopCondition(CEvaluation<TFenotype> *pcEvaluation)
{
	...
	b_ignore_optimal_at_stop = false;
	b_stop_now = false;
}//CStopCondition<TGenotype, TFenotype>::CStopCondition(CEvaluation<TFenotype> *pcEvaluation)
...
template <class TGenotype, class TFenotype>
bool CStopCondition<TGenotype, TFenotype>::bStop(CTimeCounter  *pcTimeCounter, uint32_t iIterationNumber, uint64_t iFFE, CIndividual<TGenotype, TFenotype> *pcBestIndividual)
{
	bool b_stop = false;

	if (b_stop_now == true)  return(true);

	if (b_ignore_optimal_at_stop == false)
	{
		if (pcBestIndividual)
		{
...
template <class TGenotype, class TFenotype>
bool CIterationsStopCondition<TGenotype, TFenotype>::bStop(CTimeCounter  *pcTimeCounter, uint32_t iIterationNumber, uint64_t iFFE, CIndividual<TGenotype, TFenotype> *pcBestIndividual)
{
	return CStopCondition<TGenotype, TFenotype>::bStop(pcTimeCounter, iIterationNumber, iFFE, pcBestIndividual) || iIterationNumber >= i_max_number_of_iterations;
...
template <class TGenotype, class TFenotype>
bool CProgressStopCondition<TGenotype, TFenotype>::bStop(CTimeCounter  *pcTimeCounter, uint32_t iIterationNumber, uint64_t iFFE, CIndividual<TGenotype, TFenotype> *pcBestIndividual)
{
	...
	return CStopCondition<TGenotype, TFenotype>::bStop(pcTimeCounter, iIterationNumber, iFFE, pcBestIndividual)
...
template <class TGenotype, class TFenotype>
bool CFFEStopCondition<TGenotype, TFenotype>::bStop(CTimeCounter  *pcTimeCounter, uint32_t iIterationNumber, uint64_t iFFE, CIndividual<TGenotype, TFenotype> *pcBestIndividual)
{
	return CStopCondition<TGenotype, TFenotype>::bStop(pcTimeCounter, iIterationNumber, iFFE, pcBestIndividual) || iFFE >= i_max_number_of_ffe;
